...
activities = {
    ...
    "Music Band": {
        ...
        "max_participants": 25,
        "participants": ["lucas@mergington.edu", "mia@mergington.edu", "ethan@mergington.edu"]
    },
    "Debate Club": {
    ...
    "Science Olympiad": {
        "description": "Compete in science-based challenges and tournaments",
...
def unregister_from_activity(activity_name: str, email: str):
    ...
    # Check if email is in participants
